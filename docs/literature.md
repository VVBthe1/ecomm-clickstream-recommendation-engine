...
| 10 | Obaidat et al. | 2025 | IEEE Access | SARIMAX vs XGBoost | Jordanian dairy facility (6 products, Jan–Dec 2023) | MAPE, MAE, RMSE (SARIMAX 5.55% vs XGBoost 7.04%; DM p=0.012) | SARIMAX beat XGBoost on seasonal dairy; ML wins are product/domain dependent |
